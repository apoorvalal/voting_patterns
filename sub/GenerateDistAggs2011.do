...
gen WaterQualIndex = (H03 < 2) + (H03 < 3)

gen EnergyQualIndex = (H04 == 3 | H04 == 6 | H04 == 5) + (H05 == 1) + 0.5*(H05 == 4) +  0.5*(H05 == 2 |H04 == 2)

gen SanitationQualIndex = (H06<3) + (H06<4)

gen GenderEquityPropertyIndex = (H08 == 1 | H 09 == 1)
